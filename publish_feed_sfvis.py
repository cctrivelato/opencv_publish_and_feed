        ...
        try:
            ...
            if time_spent:
                query = ("INSERT INTO sfvis0" + str(sfvis) +"_cvdata"
                         "(WorkStation_Camera, Vision_System, Old_Status, Period_Status_last, New_Status, People_Count, Frame_Rate, Presence_Change_Total, Presence_Change_Rate) "
                         "VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)")
                data = (station, sfvis, previous_status, time_spent, status, people_count, frame_rate, presence_total, presence_rate)

                query1 = ("INSERT INTO sfvis0" + str(sfvis) +"_grafdash"
                         "(WorkStation_Camera, Vision_System, Old_Status, Period_Status_last, New_Status, People_Count, Frame_Rate, Presence_Change_Total, Presence_Change_Rate) "
                         "VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)")
                data1 = (station, sfvis, previous_status, time_spent, status, people_count, frame_rate, presence_total, presence_rate)
            else:
                query = ("INSERT INTO sfvis0" + str(sfvis) + "_cvdata"
                         "(WorkStation_Camera, Vision_System, Old_Status, New_Status, People_Count, Frame_Rate, Presence_Change_Total, Presence_Change_Rate) "
                         "VALUES (%s, %s, %s, %s, %s, %s, %s, %s)")
                data = (station, sfvis, previous_status, status, people_count, frame_rate, presence_total, presence_rate)
                
                query1 = ("INSERT INTO sfvis0" + str(sfvis) + "_grafdash"
                         "(WorkStation_Camera, Vision_System, Old_Status, New_Status, People_Count, Frame_Rate, Presence_Change_Total, Presence_Change_Rate) "
                         "VALUES (%s, %s, %s, %s, %s, %s, %s, %s)")
                data1 = (station, sfvis, previous_status, status, people_count, frame_rate, presence_total, presence_rate)
...
def main():
    ...
    sfvis = 1  # This is the changing value
